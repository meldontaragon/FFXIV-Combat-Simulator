from ffxivcalc.Jobs.Base_Spell import DOTSpell, ManaRequirement, empty
from ffxivcalc.Jobs.Healer.Healer_Spell import SageSpell
from ffxivcalc.Jobs.Healer.Sage.Sage_Spell import SageSpell
import copy
...
Eukrasia = SageSpell(
    24290, True, 1, 1, 0, 0, ApplyEukrasia, []
)  # Since only 1 sec CD, no real need to put a requirement
...
Zoe = SageSpell(
    24300, False, 0, 0, 0, 0, ApplyZoe, [ZoeRequirement]
)  # https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.leagueoflegends.com%2Fen-pl%2Fchampions%2Fzoe%2F&psig=AOvVaw2X9QcnXQ_CGp3xMY8MLua9&ust=1654295724885000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCJjl4oPqj_gCFQAAAAAdAAAAABAD
