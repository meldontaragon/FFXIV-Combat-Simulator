...
# HealGCD
Succor = ScholarSpell(
    186, True, 2, 2.5, 0, 1000, ApplyAdloquium, [AdloquiumRequirement]
)  ##This action has apply and requirement because of recitation
Adloquium = ScholarSpell(
    185, True, 2, 2.5, 0, 1000, ApplyAdloquium, [AdloquiumRequirement]
)  # This action has apply and requirement because of recitation
...
Excogitation = ScholarSpell(
    7434, False, 0, 0, 0, 0, ApplyExcogitation, [ExcogitationRequirement, AetherHealRequirement]
)  # Can be used by recitation
...
Indomitability = ScholarSpell(
    3583, False, 0, 0, 0, 0, ApplyIndomitability, [IndomitabilityRequirement, AetherHealRequirement]
)  # Can be used by recitation
...
Aetherpact = ScholarSpell(
    7437, False, 0, 0, 0, 0, empty, []
)  # No requirement, since 3 sec cd, so not really worth it imo
