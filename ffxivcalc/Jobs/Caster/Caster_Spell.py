...
from ffxivcalc.Jobs.PlayerEnum import JobEnum, SpeedEnum
...
class CasterSpell(Spell):
    def __init__(
        self, id, GCD, CastTime, RecastTime, Potency, ManaCost, Effect, Requirement, SSType: SpeedEnum = SpeedEnum.SpS
    ):
...
class BLMSpell(CasterSpell):
    ...
    def __init__(self, id, GCD, CastTime, RecastTime, Potency, ManaCost, IsFire, IsIce, Effect, Requirement):
        super().__init__(
            id, GCD, CastTime, RecastTime, Potency, ManaCost, Effect, Requirement
        )  # Calls constructor of Spell
...
class RedmageSpell(CasterSpell):
    def __init__(
        ...
        BlackCost=0,
        WhiteCost=0,
        SSType: SpeedEnum = SpeedEnum.SpS,
    ):
        super().__init__(id, GCD, CastTime, RecastTime, Potency, ManaCost, Effect, Requirement, SSType=SSType)
...
class SummonerSpell(CasterSpell):
    def __init__(self, id, GCD, CastTime, RecastTime, Potency, ManaCost, Effect, Requirement):
        super().__init__(id, GCD, CastTime, RecastTime, Potency, ManaCost, Effect, Requirement, SSType=SpeedEnum.SpS)
